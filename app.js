...
async function recreateDB() {
  ...
  const site2 = new HeritageSite({ site_name: "Colosseum", location: "Italy", year_established: 72 });
  const site3 = new HeritageSite({ site_name: "Acropolis of Athens", location: "Greece", year_established: 500 });
